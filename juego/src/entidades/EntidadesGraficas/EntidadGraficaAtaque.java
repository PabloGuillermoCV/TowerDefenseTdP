		...
		if(!bloqueado) {
			...
			graficoActual.setVisible(true);
				System.out.println("Estoy volando graficamente");
					//como como me muevo depende de la orientacion del proyectil y hay 8 direcciones posibles, 
					//es mejor un switch que 8 ifs seguidos
					switch(orientacion){
						case 0:
							miMapa.getFondo().add(graficoActual);
							this.graficoActual.setBounds(this.pos.getX() + vel, this.pos.getY(), 16, 16);
							this.pos.setX(this.pos.getX() + vel);
							break;
						case 1:
							miMapa.getFondo().add(graficoActual);
							this.graficoActual.setBounds(this.pos.getX() + vel, this.pos.getY() + vel,16, 16);
							this.pos.setX(this.pos.getX() + vel);
							this.pos.setY(this.pos.getY() + vel);
							break;
						case 2:
							miMapa.getFondo().add(graficoActual);
							this.graficoActual.setBounds(this.pos.getX(), this.pos.getY() + vel, 16, 16);
							this.pos.setY(this.pos.getY() + vel);
							break;
						case 3:
							miMapa.getFondo().add(graficoActual);
